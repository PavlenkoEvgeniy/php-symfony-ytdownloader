...
final class SourceController extends AbstractController
{
        ...
        foreach ($sources as $source) {
            ...
            $items[]   = [
                ...
                'created_at' => $createdAt
                    ...
                    : null,
                'download_url' => $this->generateUrl('api_v2_source_download', ['id' => $source->getId()]),
            ];
        }
    ...
    #[Route(path: '/api/v2/source/{id}/download', name: 'api_v2_source_download', methods: [Request::METHOD_GET])]
    ...
    #[Route(path: '/api/v2/source/{id}', name: 'api_v2_source_delete', methods: [Request::METHOD_DELETE])]
