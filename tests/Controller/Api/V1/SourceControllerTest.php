...
final class SourceControllerTest extends WebTestCase
{
    ...
    public function testIndexReturnsItems(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, '/api/v1/source', server: [
    ...
    public function testDownloadReturnsFile(): void
    {
        ...
        $this->assertStringContainsString('test-download.mp4', (string) $this->client->getResponse()->headers->get('content-disposition'));
    }
